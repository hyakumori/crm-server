# Generated by Django 3.0.4 on 2020-04-03 10:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_id', models.CharField(max_length=255, null=True)),
                ('attributes', django.contrib.postgres.fields.jsonb.JSONField(default=dict)),
                ('name', django.contrib.postgres.fields.jsonb.JSONField(default=hyakumori_crm.crm.models.customer.DefaultCustomer.name)),
                ('address', django.contrib.postgres.fields.jsonb.JSONField(default=hyakumori_crm.crm.models.customer.DefaultCustomer.address)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_id', models.CharField(max_length=255, null=True)),
                ('attributes', django.contrib.postgres.fields.jsonb.JSONField(default=dict)),
                ('cadastral', django.contrib.postgres.fields.jsonb.JSONField(default=hyakumori_crm.crm.models.forest.DefaultForest.cadastral)),
                ('owner', django.contrib.postgres.fields.jsonb.JSONField(default=hyakumori_crm.crm.models.forest.DefaultForest.owner)),
                ('contract', django.contrib.postgres.fields.jsonb.JSONField(default=hyakumori_crm.crm.models.forest.DefaultForest.contract)),
