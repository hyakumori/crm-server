...
from .views import get_user_permissions, get_resource_permissions, assign_user_resource_permissions, add_user_group, \
    setup_groups, remove_user_group

urlpatterns = [
    path("permissions/user/", get_user_permissions, name="list-user-permissions"),
    path("permissions/assign/", assign_user_resource_permissions, name="assign-permissions"),
    path("permissions/unassign/", assign_user_resource_permissions, name="assign-permissions"),
